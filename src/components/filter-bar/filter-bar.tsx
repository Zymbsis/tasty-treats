...
import ResetButton from "@/components/filter-bar/reset-button";

import { TimeOption } from "@/lib/utils/generateTimeOptions";
import { SEARCH_PARAMS } from "@/lib/constants/search-params";
import { Area, Ingredient } from "@/lib/types/api.types";
...
const FilterBar = ({ ingredients, areas, timeOptions }: Props) => {
  ...
  const handleUpdateQuery = (key: string, value: Key | null) => {
    ...
    query.set(SEARCH_PARAMS.PAGE, "1");
